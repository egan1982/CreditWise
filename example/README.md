...
- You can place your use cases in a new folder under [`.example/`](https://github.com/egan1982/CreditWise/tree/main/example/). We recommend following the folder structure of [`.example/analysis_on_student_loan/`](https://github.com/egan1982/CreditWise/tree/main/example/analysis_on_student_loan), which includes three parts:
